  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    // }
      try {
          ...
          if (data.status === true) {
              // ✅ Login successful
              localStorage.setItem('token', data.token); // save token if backend returns it
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      toast({
        ...
        description: "Please check your email inbox for the confirmation link to activate your account.",
      });
    }
